...
embedding_dir = 'coco_clip_embeddings.pth'
...
model = dict(
    ...
    language_model=dict(
        type='LearnableCategoryQuerySelfAttentionCOCOSwinL',
    ...
    bbox_head=dict(
        ...
        contrastive_cfg=dict(max_text_len=30, log_scale='auto', bias=True),
        loss_cls=dict(
            type='FocalLoss',
            use_sigmoid=True,
            gamma=2.0,
...
coco_dataset = dict(
    type='ODVGDataset',
    data_root='data/coco/',
    ann_file='annotations/instances_train2017_od_clean.json',
...
data_root = '/mnt/public/usr/sunzhichao/mmdetection/data/coco/'
...
load_from = "stage1/cqdino_swinl_coco_stage1.pth"